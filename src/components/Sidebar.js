...
import ReactHero from "../assets/img/a.jpg";
import ProfilePicture from "../assets/img/team/p.webp";
  ...
  return (
    <>
      <Navbar
        ...
        collapseOnSelect
        variant="dark"
        className="navbar-theme-dark bg-dark px-4 d-md-none ">
        <Navbar.Brand
          className="me-lg-5"
          as={Link}
