...
import Profile1 from "../assets/img/team/p.webp";
  ...
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        ...
        />
        <Card.Title>Marwa Jawad</Card.Title>
        <Card.Subtitle className="fw-normal">Engineer</Card.Subtitle>
        <Card.Text className="text-gray mb-4">Babylon,Iraq</Card.Text>
              ...
              <div className="d-flex">
                ...
                <div className="d-md-block text-start">
                  ...
                  <div className="text-gray small">
                    JPG, GIF or PNG. Max size of 500K
                  </div>
                </div>
              </div>
            </div>
...
export const TeamMembersWidget = () => {
  const TeamMember = (props) => {
    ...
    const status = {
      ...
      inMeeting: { color: "success", label: "Online" },
